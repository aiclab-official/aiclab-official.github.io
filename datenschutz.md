...
**Name:** GitHub, Inc.  
**Adresse / Anschrift:** 88 Colin P. Kelly Jr. Street, San Francisco, CA 94107, USA  
**Datenschutzerklärung URL:** https://github.com
...
- Telefon: +49-15-90-67-20-653
- E-Mail: info[[at-sign]]aic-lab.com (Bitte ersetzen Sie [[at-sign]] durch @)
...
Vertragserfüllung oder zur Durchführung vorvertraglicher Maßnahmen erforderlich, verarbeiten wir Ihre Daten auf Grundlage des Art. 6 Abs. 1 lit. b DSGVO. Des Weiteren verarbeiten wir Ihre Daten, sofern diese
...
## 6.Zahlungsanbieter und e-Commerce (Zusatz)

### Datenverarbeitung bei digitalen Inhalten
Wir verarbeiten Ihre Daten (wie Name und E-Mail-Adresse), um Ihnen den Kauf und die manuelle Personalisierung digitaler Inhalte (PDF) zu ermöglichen. Die Rechtsgrundlage hierfür ist Art. 6 Abs. 1 lit. b DSGVO (Vertragserfüllung).

### Gumroad und Zahlungsdienste
Für die Abwicklung von Zahlungen nutzen wir den externen Anbieter Gumroad (Gumroad Inc.). Wenn Sie ein Produkt kaufen, werden Ihre Zahlungsdaten an Gumroad sowie die dort integrierten Zahlungsdienstleister (wie PayPal oder Stripe) übertragen. Dies ist für die Abwicklung des Kaufs zwingend erforderlich. Die Datenverarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO. Weitere Informationen zum Datenschutz finden Sie in der Datenschutzerklärung von Gumroad (https://gumroad.com).
